...
--
-- Host: localhost:8889
-- Generation Time: Mar 30, 2019 at 08:22 AM
...
CREATE TABLE `catalogs` (
  ...
  `image` text,
  `admin_options` text,
  `is_main1` int(11) DEFAULT NULL,
  `is_main2` int(11) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `catalogs` (`id`, `url`, `text`, `title`, `catalog_id`, `template`, `type`, `multi_domain`, `created_at`, `updated_at`, `sort`, `image`, `admin_options`, `is_main1`, `is_main2`) VALUES
(3, 'office_business-class', '\r\nКабинеты, представленные в разделе Econom class, популярны у руководителей, имеющих репутацию людей практичных, требовательных к себе и своим подчиненным. Эти модели отличает износостойкость покрытий, строгость форм и лаконичность дизайна.', 'Кабинеты Business class', 0, NULL, NULL, NULL, '2019-03-26 21:43:52', '2019-03-26 21:57:53', 3, '/storage/office-2.png', '', 1, 0),
(2, 'office_econom-class', '\r\nКабинеты, представленные в разделе Econom class, популярны у руководителей, имеющих репутацию людей практичных, требовательных к себе и своим подчиненным. Эти модели отличает износостойкость покрытий, строгость форм и лаконичность дизайна.', 'Кабинеты Econom class', 0, NULL, NULL, NULL, '2019-03-26 21:41:11', '2019-03-26 21:41:11', 2, '/storage/office-1.png', '', 1, 0),
(4, 'office_first-class', '<p><span>В любом помещении, которое так или иначе играет роль в нашем жизненно процессе, стоит мебель. А ведь её функция выходит далеко за пределы &laquo;быть способным удержать на себе чашку&raquo;, &laquo;быть хранилищем для книг&raquo;, &laquo;держать на себе вазу с цветами, а также весь обеденный сервис с содержимым в полдень&raquo;. Каждая вещь, которая нас окружает, так или иначе влияет на нас самих, действуя через наше восприятие окружающей действительности. Первыми это поняли японцы. Восточные народы вообще очень чувствительны к тонким душевным изменениям. Они первыми осознали, насколько велика роль обстановки в жизни человека, и превратили это взаимодействие окружающей обстановки с человеком в настоящее искусство. То же самое и с пространством, нас окружающем &ndash; оно должно быть гармоничным. Что в офисе, что дома, что на даче. Когда нужно просто что-то купить, можно идти в первый попавшийся магазин офисной мебели в Москве, а когда нужно что-то более серьезное - вы приходите к поставщику. Всегда рады видеть Вас в наших салонах!</span></p>', 'Кабинеты First class', 0, NULL, NULL, NULL, '2019-03-26 21:44:27', '2019-03-26 21:44:27', 4, '/storage/office-3.png', '', 1, 0),
(6, 'office_premium-class', '<p><span>В любом помещении, которое так или иначе играет роль в нашем жизненно процессе, стоит мебель. А ведь её функция выходит далеко за пределы &laquo;быть способным удержать на себе чашку&raquo;, &laquo;быть хранилищем для книг&raquo;, &laquo;держать на себе вазу с цветами, а также весь обеденный сервис с содержимым в полдень&raquo;. Каждая вещь, которая нас окружает, так или иначе влияет на нас самих, действуя через наше восприятие окружающей действительности. Первыми это поняли японцы. Восточные народы вообще очень чувствительны к тонким душевным изменениям. Они первыми осознали, насколько велика роль обстановки в жизни человека, и превратили это взаимодействие окружающей обстановки с человеком в настоящее искусство. То же самое и с пространством, нас окружающем &ndash; оно должно быть гармоничным. Что в офисе, что дома, что на даче. Когда нужно просто что-то купить, можно идти в первый попавшийся магазин офисной мебели в Москве, а когда нужно что-то более серьезное - вы приходите к поставщику. Всегда рады видеть Вас в наших салонах!</span></p>', 'Кабинеты Premium class', 0, NULL, NULL, NULL, '2019-03-26 21:48:27', '2019-03-26 21:48:27', 6, '/storage/office-4.png', '', 1, 0),
(7, 'area-community', '\r\nКабинеты, представленные в разделе Econom class, популярны у руководителей, имеющих репутацию людей практичных, требовательных к себе и своим подчиненным. Эти модели отличает износостойкость покрытий, строгость форм и лаконичность дизайна.', 'Зоны коммуникаций', 0, NULL, NULL, NULL, '2019-03-26 21:53:04', '2019-03-26 21:53:04', 7, '/storage/area-community.png', '', 0, 1),
(8, 'area-visit', '', 'Приемные зоны', 0, NULL, NULL, NULL, '2019-03-26 21:54:22', '2019-03-26 21:54:22', 8, '/storage/area-visit.png', '', 0, 1),
(13, 'Reception_stands', '', 'Приемные стойки', 8, NULL, NULL, NULL, '2019-03-28 19:38:43', '2019-03-28 19:38:43', 13, '/storage/reseption-1.jpg', '', 0, 0),
(14, 'panno-wall', '', ' Настенные панно', 8, NULL, NULL, NULL, '2019-03-28 19:43:08', '2019-03-28 19:43:08', 14, '/storage/reseption-1.jpg', '', 0, 0),
(15, 'test', '<p>подкатегория&nbsp;</p>', 'Тестовая подкатегория', 2, NULL, NULL, NULL, '2019-03-28 21:04:03', '2019-03-28 21:04:03', 15, '/storage/reseption-1.jpg', '', 0, 0),
(9, 'area-work', '<p><span>В любом помещении, которое так или иначе играет роль в нашем жизненно процессе, стоит мебель. А ведь её функция выходит далеко за пределы &laquo;быть способным удержать на себе чашку&raquo;, &laquo;быть хранилищем для книг&raquo;, &laquo;держать на себе вазу с цветами, а также весь обеденный сервис с содержимым в полдень&raquo;. Каждая вещь, которая нас окружает, так или иначе влияет на нас самих, действуя через наше восприятие окружающей действительности. Первыми это поняли японцы. Восточные народы вообще очень чувствительны к тонким душевным изменениям. Они первыми осознали, насколько велика роль обстановки в жизни человека, и превратили это взаимодействие окружающей обстановки с человеком в настоящее искусство. То же самое и с пространством, нас окружающем &ndash; оно должно быть гармоничным. Что в офисе, что дома, что на даче. Когда нужно просто что-то купить, можно идти в первый попавшийся магазин офисной мебели в Москве, а когда нужно что-то более серьезное - вы приходите к поставщику. Всегда рады видеть Вас в наших салонах!</span></p>', 'Зоны работы сотрудников', 0, NULL, NULL, NULL, '2019-03-26 21:54:46', '2019-03-26 21:54:46', 9, '/storage/area-work.png', '', 0, 1),
(10, 'area-wait', '<p><span>В любом помещении, которое так или иначе играет роль в нашем жизненно процессе, стоит мебель. А ведь её функция выходит далеко за пределы &laquo;быть способным удержать на себе чашку&raquo;, &laquo;быть хранилищем для книг&raquo;, &laquo;держать на себе вазу с цветами, а также весь обеденный сервис с содержимым в полдень&raquo;. Каждая вещь, которая нас окружает, так или иначе влияет на нас самих, действуя через наше восприятие окружающей действительности. Первыми это поняли японцы. Восточные народы вообще очень чувствительны к тонким душевным изменениям. Они первыми осознали, насколько велика роль обстановки в жизни человека, и превратили это взаимодействие окружающей обстановки с человеком в настоящее искусство. То же самое и с пространством, нас окружающем &ndash; оно должно быть гармоничным. Что в офисе, что дома, что на даче. Когда нужно просто что-то купить, можно идти в первый попавшийся магазин офисной мебели в Москве, а когда нужно что-то более серьезное - вы приходите к поставщику. Всегда рады видеть Вас в наших салонах!</span></p>', 'Зоны ожидания', 0, NULL, NULL, NULL, '2019-03-26 21:55:24', '2019-03-26 21:55:24', 10, '/storage/area-wait.png', '', 0, 1),
(11, 'chair-and-armchair', '<p><span>В любом помещении, которое так или иначе играет роль в нашем жизненно процессе, стоит мебель. А ведь её функция выходит далеко за пределы &laquo;быть способным удержать на себе чашку&raquo;, &laquo;быть хранилищем для книг&raquo;, &laquo;держать на себе вазу с цветами, а также весь обеденный сервис с содержимым в полдень&raquo;. Каждая вещь, которая нас окружает, так или иначе влияет на нас самих, действуя через наше восприятие окружающей действительности. Первыми это поняли японцы. Восточные народы вообще очень чувствительны к тонким душевным изменениям. Они первыми осознали, насколько велика роль обстановки в жизни человека, и превратили это взаимодействие окружающей обстановки с человеком в настоящее искусство. То же самое и с пространством, нас окружающем &ndash; оно должно быть гармоничным. Что в офисе, что дома, что на даче. Когда нужно просто что-то купить, можно идти в первый попавшийся магазин офисной мебели в Москве, а когда нужно что-то более серьезное - вы приходите к поставщику. Всегда рады видеть Вас в наших салонах!</span></p>', 'Стулья и кресла', 0, NULL, NULL, NULL, '2019-03-26 21:55:59', '2019-03-26 21:55:59', 11, '/storage/chair-and-armchair.png', '', 0, 1),
(12, 'office-light', '<p><span>В любом помещении, которое так или иначе играет роль в нашем жизненно процессе, стоит мебель. А ведь её функция выходит далеко за пределы &laquo;быть способным удержать на себе чашку&raquo;, &laquo;быть хранилищем для книг&raquo;, &laquo;держать на себе вазу с цветами, а также весь обеденный сервис с содержимым в полдень&raquo;. Каждая вещь, которая нас окружает, так или иначе влияет на нас самих, действуя через наше восприятие окружающей действительности. Первыми это поняли японцы. Восточные народы вообще очень чувствительны к тонким душевным изменениям. Они первыми осознали, насколько велика роль обстановки в жизни человека, и превратили это взаимодействие окружающей обстановки с человеком в настоящее искусство. То же самое и с пространством, нас окружающем &ndash; оно должно быть гармоничным. Что в офисе, что дома, что на даче. Когда нужно просто что-то купить, можно идти в первый попавшийся магазин офисной мебели в Москве, а когда нужно что-то более серьезное - вы приходите к поставщику. Всегда рады видеть Вас в наших салонах!</span></p>', 'Офисный свет', 0, NULL, NULL, NULL, '2019-03-26 21:56:33', '2019-03-26 21:56:33', 12, '/storage/office-light.png', '', 0, 1);
...
INSERT INTO `options` (`id`, `url`, `text`, `title`, `option_id`, `template`, `type`, `multi_domain`, `created_at`, `updated_at`, `sort`, `logo`, `phone`, `extra_phone`, `email`, `addr`, `recieve_email`, `is_smtp`, `email_login`, `email_pass`, `meta`, `metric`, `admin_options`, `addr_map`, `banner_title`, `banner_subtitle`, `banner_btn_text`, `banner_btn_url`) VALUES
(1, 'all', NULL, NULL, NULL, NULL, NULL, NULL, '2019-03-25 11:29:33', '2019-03-27 16:32:13', 1, '/storage/logo.png', '(495) 760-30-58 ', '', 'moscow@advant-mebel.ru', 'г. Москва, Ленинградский проспект 80', '', 0, '', '', '', '', '', 'Москва, улица 1905 года, 7с1 ', 'СТИЛЬНЫЕ<br>И ДОЛГОВЕЧНЫЕ', 'мебельные решения для компаний любого уровня', 'Перейти в каталог', '/catalogs/office_econom-class');
...
(4, 'news', '', 'Новости', NULL, NULL, NULL, NULL, '2019-03-29 17:34:10', '2019-03-29 17:34:10', 4, 0, '', '');
...
INSERT INTO `products` (`id`, `url`, `text`, `title`, `product_id`, `template`, `type`, `multi_domain`, `created_at`, `updated_at`, `sort`, `image`, `description`, `price`, `catalog_id`, `admin_options`, `is_main`) VALUES
...
(3, 'Forte', '<p><span>Описание товара&nbsp;<span>Forte</span></span></p>', 'Forte', NULL, NULL, NULL, NULL, '2019-03-26 23:46:44', '2019-03-26 23:46:44', 3, '/storage/product-3.png', NULL, '6499 €', 2, '', 1),
(4, 'MultipliCEO', '<p><span>Описание товара&nbsp;<span>MultipliCEO</span></span></p>', 'MultipliCEO', NULL, NULL, NULL, NULL, '2019-03-26 23:46:58', '2019-03-26 23:46:58', 4, '/storage/product-4.png', NULL, '6499 €', 2, '', 1),
(5, 'Tempio', '<p><span>Описание товара&nbsp;<span>Tempio</span></span></p>', 'Tempio', NULL, NULL, NULL, NULL, '2019-03-26 23:46:29', '2019-03-26 23:46:29', 2, '/storage/product-2.png', NULL, '6499 €', 2, '', 1),
(6, 'Conte', '<p><span>Описание товара&nbsp;<span>Conte</span></span></p>', 'Conte', NULL, NULL, NULL, NULL, '2019-03-26 23:46:05', '2019-03-26 23:46:05', 1, '/storage/product-1.png', NULL, '6499 €', 2, '', 1),
(7, 'Fasta', '<p>Бла-бла</p>', 'Fasta', NULL, NULL, NULL, NULL, '2019-03-28 20:39:29', '2019-03-28 20:41:24', 7, '/storage/reseption-1.jpg', NULL, '1000 руб.', 13, '', NULL),
(8, 'Luna', '<p>Бла-бла</p>', 'Luna', NULL, NULL, NULL, NULL, '2019-03-28 20:39:54', '2019-03-28 20:41:28', 8, '/storage/reseption-2.jpg', NULL, '1000 руб.', 13, '', NULL),
(9, 'Factory-Light', '<p>Бла-бла</p>', 'Factory Light', NULL, NULL, NULL, NULL, '2019-03-28 20:40:11', '2019-03-28 20:41:48', 9, '/storage/reseption-3.jpg', NULL, '1000 руб.', 13, '', NULL),
(10, 'Extra-Long', '<p>Бла-бла</p>', 'Extra Long', NULL, NULL, NULL, NULL, '2019-03-28 20:40:27', '2019-03-28 20:41:40', 10, '/storage/reseption-4.jpg', NULL, '1000 руб.', 13, '', NULL),
(11, 'Factory-Cotto', '<p>Бла-бла</p>', 'Factory Cotto', NULL, NULL, NULL, NULL, '2019-03-28 20:40:42', '2019-03-28 20:41:53', 11, '/storage/reseption-5.jpg', NULL, '1000 руб.', 13, '', NULL),
(12, 'lava', '<p><span>Кабинет Lava сочетает продуманный стиль и передовые технологии. Все детали кабинета спроектированы так, чтобы вы могли получить максимальную эффективность рабочего пространства. </span></p>\r\n<p><span>Сочетание современных материалов и цветов натуральных пород дерева добавят неповторимый внешний вид вашему офису и будут радовать вас изо дня в день. Функциональное решение для офиса включает два типа письменных столов, широкий ассортимент систем хранения и столов для переговоров.</span></p>', 'Lava', NULL, NULL, NULL, NULL, '2019-03-29 00:47:53', '2019-03-29 01:14:46', 12, '/storage/lava-main-1.jpg', NULL, '2, 305 €', 2, '', NULL);

...
--
-- Host: localhost:8889
-- Generation Time: Mar 31, 2019 at 09:17 AM
...
(6, 'office_premium-class', '<p><span>В любом помещении, которое так или иначе играет роль в нашем жизненно процессе, стоит мебель. А ведь её функция выходит далеко за пределы &laquo;быть способным удержать на себе чашку&raquo;, &laquo;быть хранилищем для книг&raquo;, &laquo;держать на себе вазу с цветами, а также весь обеденный сервис с содержимым в полдень&raquo;. Каждая вещь, которая нас окружает, так или иначе влияет на нас самих, действуя через наше восприятие окружающей действительности. Первыми это поняли японцы. Восточные народы вообще очень чувствительны к тонким душевным изменениям. Они первыми осознали, насколько велика роль обстановки в жизни человека, и превратили это взаимодействие окружающей обстановки с человеком в настоящее искусство. То же самое и с пространством, нас окружающем &ndash; оно должно быть гармоничным. Что в офисе, что дома, что на даче. Когда нужно просто что-то купить, можно идти в первый попавшийся магазин офисной мебели в Москве, а когда нужно что-то более серьезное - вы приходите к поставщику. Всегда рады видеть Вас в наших салонах!</span></p>', 'Кабинеты Premium class', 0, NULL, NULL, NULL, '2019-03-26 21:48:27', '2019-03-26 21:48:27', 6, '/storage/office-4.png', '', 1, 1),
...
INSERT INTO `options` (`id`, `url`, `text`, `title`, `option_id`, `template`, `type`, `multi_domain`, `created_at`, `updated_at`, `sort`, `logo`, `phone`, `extra_phone`, `email`, `addr`, `recieve_email`, `is_smtp`, `email_login`, `email_pass`, `meta`, `metric`, `admin_options`, `addr_map`, `banner_title`, `banner_subtitle`, `banner_btn_text`, `banner_btn_url`, `news_paginator`) VALUES
(1, 'all', NULL, NULL, NULL, NULL, NULL, NULL, '2019-03-25 11:29:33', '2019-03-30 21:13:46', 1, '/storage/logo.png', '(495) 760-30-58 ', '', 'moscow@advant-mebel.ru', 'г. Москва, Ленинградский проспект 80', '', 0, '', '', '', '', '', 'Москва, улица 1905 года, 7с1 ', 'СТИЛЬНЫЕ<br>И ДОЛГОВЕЧНЫЕ', 'мебельные решения для компаний любого уровня', 'Перейти в каталог', '/catalogs/office_econom-class', 5);
...
(5, 'catalogs', '', 'Каталог', NULL, NULL, NULL, NULL, '2019-03-30 20:32:20', '2019-03-30 20:32:20', 5, 0, '', '');
